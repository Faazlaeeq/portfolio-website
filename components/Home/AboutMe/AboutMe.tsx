...
export default function AboutMe(props) {
  const technologies = [
    ["Next.js", "JavaScript (ES6+)", "Tailwind CSS", "Express.js", "MongoDB"],
          ...
          <div className="w-full md:w-7/12 space-y-4 sm:text-base text-sm ">
            <div className="font-Header ">
              <span className="text-gray-400 ">
                Hello! My name is Faaz Laeeq, and I am a passionate software engineer and problem solver, dedicated to
                creating impactful codes that thrive on the internet. My journey in computer science began in 2019 when
                I delved into the world of Web Developement using PHP. Little did I know that programming skills
            ...
            <div className="font-Header ">
              <span className="text-gray-400 ">
                ...
                refine my expertise in mobile and web development. In the realm of{" "}
                <span className="text-AAsecondary">Flutter</span>, I am dedicated to pushing boundaries and driving
                advancements.My passion for Flutter and continuous
