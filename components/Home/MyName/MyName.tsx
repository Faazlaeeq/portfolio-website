...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        I&apos;m I am Faaz Laeeq, a <span className="text-AAsecondary">software engineer</span> specializing in crafting exceptional digital experiences. With 2 years of experience in <span className="text-AAsecondary">Flutter development</span> and <span className="text-AAsecondary">WordPress website development</span>, I am dedicated to creating high-quality, reusable frontend components and implementing app modules based on product requirements. I excel in clean, efficient, and scalable code for <span className="text-AAsecondary">cross-platform hybrid apps</span> and have a strong understanding of <span className="text-AAsecondary">Object-Oriented Programming</span>. Let's collaborate to build outstanding applications and websites together! 🚀
